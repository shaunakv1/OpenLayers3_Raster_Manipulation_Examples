//Uses this answer to clip layers: http://gis.stackexchange.com/questions/185881/clipping-tilelayer-with-georeferenced-polygon-clipping-mask
//need to figure out how to apply the Raster Operations before clipping the layer
  ...
  sources: [
    new ol.source.XYZ({
      ...
      source: new ol.source.Vector({
            url: 'https://raw.githubusercontent.com/glynnbird/usstatesgeojson/master/south%20carolina.geojson',
...
var clipLayer = new ol.layer.Image({
  source: new ol.source.ImageVector({
    source: new ol.source.Vector({
      url: 'data/southcarolina.geojson',
      format: new ol.format.GeoJSON()
    }),
    style: style
  })
...
var map = new ol.Map({
  ...
  view: new ol.View({
    center: [-8947348.133389657, 3972961.562243974],
    zoom: 7
  })
});
